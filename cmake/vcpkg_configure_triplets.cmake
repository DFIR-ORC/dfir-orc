...
function(vcpkg_configure_triplets)
    ...
    if("${CMAKE_GENERATOR_TOOLSET}" STREQUAL "v141_xp")
        ...
        file(TO_NATIVE_PATH "${CMAKE_GENERATOR_INSTANCE}" VCPKG_VISUAL_STUDIO_PATH_CMAKE)
        string(REPLACE "\\" "\\\\" VCPKG_VISUAL_STUDIO_PATH ${VCPKG_VISUAL_STUDIO_PATH_CMAKE})
        set(VCPKG_VISUAL_STUDIO_PATH "\"${VCPKG_VISUAL_STUDIO_PATH}\"")
    elseif("${CMAKE_GENERATOR_TOOLSET}" STREQUAL "v141")
        set(VCPKG_PLATFORM_TOOLSET "v141")
        file(TO_NATIVE_PATH "${CMAKE_GENERATOR_INSTANCE}" VCPKG_VISUAL_STUDIO_PATH_CMAKE)
        string(REPLACE "\\" "\\\\" VCPKG_VISUAL_STUDIO_PATH ${VCPKG_VISUAL_STUDIO_PATH_CMAKE})
        set(VCPKG_VISUAL_STUDIO_PATH "\"${VCPKG_VISUAL_STUDIO_PATH}\"")
    ...
    set(VCPKG_C_FLAGS "${WINDOWS_VERSION_FLAGS} /guard:cf")
    set(VCPKG_CXX_FLAGS "/std:c++17 /D_SILENCE_ALL_CXX17_DEPRECATION_WARNINGS /guard:cf ${WINDOWS_VERSION_FLAGS}")
