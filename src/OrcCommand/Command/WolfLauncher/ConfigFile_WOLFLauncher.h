...
constexpr auto WOLFLAUNCHER_OUTCOME = 4L;
constexpr auto WOLFLAUNCHER_CHILDDEBUG = 5L;
constexpr auto WOLFLAUNCHER_GLOBAL_CMD_TIMEOUT = 6L;
constexpr auto WOLFLAUNCHER_GLOBAL_ARCHIVE_TIMEOUT = 7L;
constexpr auto WOLFLAUNCHER_WERDONTSHOWUI = 8L;
constexpr auto WOLFLAUNCHER_PRIORITY = 9L;
