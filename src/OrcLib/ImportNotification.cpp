...
struct ImportNotification_make_shared_enabler : public Orc::ImportNotification {
	inline ImportNotification_make_shared_enabler(HRESULT hr, ActionTaken action, const Orc::ImportItem& item) : Orc::ImportNotification(hr,action,item)
    {
    }
	inline ImportNotification_make_shared_enabler(HRESULT hr, ActionTaken action, Orc::ImportItem&& item) : Orc::ImportNotification(hr,action,std::move(item))
    {
    }
};
...
Orc::ImportNotification::Notification Orc::ImportNotification::MakeFailureNotification(HRESULT hr, const ImportItem& import_item)
{
	return std::make_shared<ImportNotification_make_shared_enabler>(hr, Unknown, import_item);
}

Orc::ImportNotification::Notification Orc::ImportNotification::MakeFailureNotification(HRESULT hr, ImportItem&& import_item)
{
	return std::make_shared<ImportNotification_make_shared_enabler>(hr, Unknown, import_item);
}
