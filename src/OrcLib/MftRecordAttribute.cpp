    ...
    SupportedAlgorithm required)
{
    ...
    if (required & SupportedAlgorithm::MD5 && m_Details->MD5().empty())
        needed = static_cast<SupportedAlgorithm>(needed | SupportedAlgorithm::MD5);
    if (required & SupportedAlgorithm::SHA1 && m_Details->SHA1().empty())
        needed = static_cast<SupportedAlgorithm>(needed | SupportedAlgorithm::SHA1);
    if (required & SupportedAlgorithm::SHA256 && m_Details->SHA256().empty())
