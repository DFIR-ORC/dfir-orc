    ...
    CryptoHashStream::Algorithm required)
{
    ...
    if ((required & CryptoHashStream::Algorithm::MD5) == CryptoHashStream::Algorithm::MD5 && m_Details->MD5().empty())
        needed |= CryptoHashStream::Algorithm::MD5;
    if ((required & CryptoHashStream::Algorithm::SHA1) == CryptoHashStream::Algorithm::SHA1
        && m_Details->SHA1().empty())
        needed |= CryptoHashStream::Algorithm::SHA1;
    if ((required & CryptoHashStream::Algorithm::SHA256) == CryptoHashStream::Algorithm::SHA256
        && m_Details->SHA256().empty())
