...
public:
    ...
    TableOutputExtension(std::wstring strFormat, std::wstring strXPLib, std::wstring strX86Lib, std::wstring strX64Lib, std::wstring strARM64Lib)
        : ExtensionLibrary(std::move(strFormat), std::move(strXPLib),  std::move(strX86Lib), std::move(strX64Lib), std::move(strARM64Lib)) {};
