...
public:
    ...
    virtual HRESULT Write(LONG32 dwValue, bool bInHex = false) override final { return Write_(dwValue, bInHex); };
    virtual HRESULT WriteNamed(LPCWSTR szName, LONG32 dwValue, bool bInHex = false) override final
    {
        return WriteNamed_(szName, dwValue, bInHex);
    };

    virtual HRESULT Write(ULONG64 ullValue, bool bInHex = false) override final { return Write_(ullValue, bInHex); };
    ...
    virtual HRESULT Write(LONG64 ullValue, bool bInHex = false) override final { return Write_(ullValue, bInHex); };
